...
const RiskManagementMetrics = ({ filteredTransactions }) => {
  ...
  useEffect(() => {
    ...
    const risks = filteredTransactions.map((t) => parseFloat(t.risque));
    ...
    const riskRewardRatios = filteredTransactions.map((t) => parseFloat(t.rrp));
